          ...
          <Dialog.Portal forceMount>
            ...
            <Dialog.Content asChild>
              <motion.div
                ...
                className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-2rem)] max-w-lg max-h-[90vh] overflow-y-auto bg-[#10121A] border border-[#1E2230] rounded-2xl p-6 shadow-2xl shadow-emerald-950/20 z-50 focus:outline-none"
              >
                {/* Header */}
                <div className="flex items-center justify-between border-b border-[#1E2230] pb-4 mb-5">
                  <div className="flex items-center gap-2.5">
                    ...
                    >
                      <Sparkles size={16} style={{ color: colorHex }} />
                    </div>
                    <div>
                      ...
                      <Dialog.Description className="text-xs text-[#64748B]">
                        Configura un nuevo objetivo para tu matriz arcade
                      </Dialog.Description>
                    </div>
                  </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 bg-[#08090C] border border-[#1E2230] rounded-xl text-[#F1F5F9] placeholder-[#475569] text-sm focus:outline-none focus:border-[#10B981] transition-colors font-medium"
                      autoFocus
                      required
                    />
                  </div>
                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              ...
                              isSelected
                                ? 'border-emerald-500/50 bg-[#10B981]/15 text-[#10B981]'
                  ...
                  <div className="flex items-center justify-end gap-3 pt-3 border-t border-[#1E2230]">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#10B981] hover:bg-[#059669] text-black font-mono text-xs font-bold tracking-wider transition-all duration-150 shadow-lg shadow-emerald-500/20 active:scale-95 disabled:opacity-50"
                    >
